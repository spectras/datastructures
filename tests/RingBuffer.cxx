...
TEST(RingBuffer, requirements_int) {
    using RingBuffer = typename datastructure::RingBuffer<int, 4>;
...
TEST(RingBuffer, requirements_string) {
    using RingBuffer = typename datastructure::RingBuffer<std::string, 4>;
...
TEST(RingBuffer, lifecycle) {
    ...
    using RingBuffer = typename datastructure::RingBuffer<Lifecycle, 4>;
